...
const selectCurrentPortfolioName = createSelector(
  selectPortfolioDataFeature,
  (state: PortfolioDataStoreType) => state.currentPortfolioName
);

const selectPortfolio = createSelector(
  selectPortfolioDataFeature,
  (state: PortfolioDataStoreType) => state.portfolio
);

const selectPortfoliosNames = createSelector(
  selectPortfolioDataFeature,
  (state: PortfolioDataStoreType) => state.portfoliosNames
);
